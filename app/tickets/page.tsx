      ...
      <div>
        ...
        <section className="content is-normal">
          ...
          <Link
            ...
            href="https://app.checkin.no/event/52747/javazone-2023"
          >
            <strong>Order your tickets</strong>
          </Link>
          <p>
            Note: Tickets are ordered from our ticket partner Checkin, this button will send you to
            their site
          </p>
        ...
        <section className="content is-normal">
          ...
          <p>
            ...
            includes admission to the workshops on September 5th (The workshops have limited
            seating, and participants will need to sign up. Registration opens in August).
          </p>
