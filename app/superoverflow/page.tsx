    ...
    <section className="content is-normal">
      ...
      <section className="content is-normal">
        ...
        <ul>
          ...
          <li>A full live track at Teknologihuset/Rebel with local and international speakers. The Teknologihuset/Rebel live track will also be streamed live to Oslo Spektrum</li>
