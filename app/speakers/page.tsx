    ...
    <main className={mainstyles.main}>
      <div>
        ...
        <section className="content is-normal">
          ...
          <p>
            Over the last decade JavaZone has grown to become one of the most important Java events
            in Europe! You can see for yourself – over 1500 videos from previous years talks are
          ...
          <p>
            ...
            speakers! That's why we need your help to make sure that JavaZone 2023 will be at least
            as awesome as the earlier events. If you think you have something interesting to share,
        ...
        <section className="content is-normal">
          ...
          <p>
            You should think about which format your talk will work best in. Are you presenting a
            new idea, or do you require more time to elaborate on your subject? How hands-on do you
            want to be? We have three formats you can present your material in.
          </p>
          ...
          <TalkTypeCard type="Lightning talks" timing="10 or 20 minutes">
            <p>
              ...
              topic? Then you should strongly consider the lightning talk format. Note that the
              10-20 minute time limit is strictly enforced!
            </p>
          </TalkTypeCard>
          ...
          <TalkTypeCard type="Presentations" timing="45 or 60 minutes">
            <p>
              ...
              elaborate on an idea. When submitting your talk, please indicate clearly in the
              outline how much time is reserved for questions.
            </p>
          </TalkTypeCard>
        ...
        <section className="content is-normal">
          ...
          <p>
            ...
            consider all talks based on their relevance to developers and technical architects. We
            do however set a focus on technology surrounding the JVM when selecting talks.
          </p>
        </section>
        ...
        <section className="content is-normal">
          ...
          <p>
            ...
            from us immediately. We do however answer all submissions and will do so no later than
            end of June.
          </p>
          <p>
            Our advice to you is simple. <strong>Submit early!</strong> The earlier you submit, the
            more likely you are to be noticed. Avoid drowning in the end-of-Call for
            Speakers-tsunami!
          </p>
          <br />
        ...
        <section className="content is-normal">
          ...
          <p>
            JavaZone is proud to be an independent and community-driven conference. It is organized
            by volunteers from <a href="https://javabin.no">javaBin</a> (the Norwegian Java User
