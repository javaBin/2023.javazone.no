    ...
    <section className="content is-normal">
      ...
      <section className="block">
        ...
        <p>
          ...
          Even though JavaZone has a place for many themes, there are some proposals that don't fit.
          Some proposals are rejected because we feel the presentation would be better served at a
