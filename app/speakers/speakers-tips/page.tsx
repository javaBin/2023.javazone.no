...
export default function SpeakersTipsPage() {
  return (
    <section className="block mb-6">
      <h1 className="text-4xl leading-tight font-semibold text-[#FED12D]">
        Submission tips for speakers
      </h1>

      <section className="block">
        <h2 className="text-3xl text-[#FED12D] font-semibold mb-4">
      ...
      <section className="block">
        ...
        <h3 className="text-2xl text-[#FED12D] font-semibold mb-2">Create a good title</h3>
        <p className="mb-4">
        ...
        <h3 className="text-2xl text-[#FED12D] font-semibold mb-2">Write a catchy abstract</h3>
        ...
        <h3 className="text-2xl text-[#FED12D] font-semibold mb-2">Provide a detailed outline</h3>
        ...
        <h3 className="text-2xl text-[#FED12D] font-semibold mb-2">Be concise</h3>
        ...
        <h3 className="text-2xl text-[#FED12D] font-semibold mb-2">Include supporting materials</h3>
        ...
        <h3 className="text-2xl text-[#FED12D] font-semibold mb-2">Send in multiple proposals</h3>
        ...
        <h3 className="text-2xl text-[#FED12D] font-semibold mb-2">{`... but please don't spam us`}</h3>
        ...
        <h3 className="text-2xl text-[#FED12D] font-semibold mb-2">Do not shout</h3>
      ...
      <section className="block">
        <h2 className="text-3xl text-[#FED12D] font-semibold mb-4">Why was my talk rejected?</h2>
        <p className="mb-4">
        ...
        <h3 className="text-2xl text-[#FED12D] font-semibold mb-2">Not Enough information</h3>
        ...
        <h3 className="text-2xl text-[#FED12D] font-semibold mb-2">The proposal is too thin</h3>
        ...
        <h3 className="text-2xl text-[#FED12D] font-semibold mb-2">You were unlucky</h3>
        <p className="mb-4">
