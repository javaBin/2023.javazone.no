...
export default function Theme() {
  ...
  return (
    <div>
      ...
      <div>
        <SectionContent src={"/images/JavaZone2022Donut.jpeg"} alt={"donut"}
        ...
        <SectionContent src={"/images/JavaZone2022Rubix.jpeg"} alt={"rubix"}
        ...
        <SectionContent src={"/images/JavaZone2022Arcade.jpeg"} alt={"arcade"}
      ...
      <div className={"mt-5"}>
        <SectionContent src={"/images/JavaZone2022Pool.jpeg"} alt={"pool"} content={"Finally"}
...
const SectionContent = (props: {
  ...
  return (
    <section className={`content is-normal ${styles.displayFlex}`} style={props.style}>
      ...
      <div className={themeStyles.pDiv} data-aos="fade" data-aos-duration="1000" data-aos-delay="500">
        <h1>{props.content}</h1>
